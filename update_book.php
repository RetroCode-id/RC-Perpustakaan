...
$book = index("SELECT * FROM tb_buku WHERE no_buku = $no_buku")[0];

if (isset($_POST["ubah_koleksi"])) {
                ...
                <div class="col">
                  ...
                  <form action="" method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="no_buku" name="no_buku" value="<?= $book["no_buku"]; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="tahun_terbit" name="tahun_terbit" value="<?= $book["tahun_terbit"]; ?>">
                    </div>
                    <div class="form-group">
                      ...
                      <select class="form-control" id="status" name="status">
                        ...
                        <option selected>belum dipinjam</option>
                        <?php endif; ?>
                      </select>
                    </div>
                    <div class="form-group">
                      <button type="submit" name="ubah_koleksi" class="btn btn-outline-primary btn-block">ubah koleksi</button>
                    </div>
                  </form>
